...
export default function About() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 lg:px-12 pt-12 md:pt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-16 border-b border-[#242423]/10">
        
        {/* Left Column: Overview Paragraphs */}
        <div className="lg:col-span-7 space-y-6 font-sans text-sm md:text-base text-[#242423]/80 leading-relaxed">
          <p>
        ...
        <div className="lg:col-span-5 space-y-8 flex flex-col justify-center">
          ...
          <div className="border-l-4 border-[#f5cb5c] pl-6 py-2 bg-[#cfdbd5] rounded-r-xs">
            <span className="font-space text-[10px] font-bold tracking-widest text-[#242423]/50 uppercase block mb-3">
              THE VISION
            </span>
            <p className="font-fraunces text-xl md:text-2xl italic font-normal text-[#242423] leading-relaxed">
      ...
      <div className="py-16">
        <div className="mb-12">
          <h2 className="font-space text-xs font-bold tracking-widest text-[#f5cb5c] uppercase">
            OUR BRAND PILLARS
          </h2>
          <p className="font-fraunces text-2xl md:text-3xl text-[#242423] mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {coreValues.map((value, idx) => (
            <div key={idx} className="border border-[#242423]/10 p-6 bg-[#cfdbd5] space-y-4 hover:border-[#f5cb5c] transition duration-200">
              <div className="font-fraunces text-lg font-bold text-[#242423]/30 select-none">
                0{idx + 1}
              </div>
              <h3 className="font-space text-xs font-bold tracking-wider text-[#242423] uppercase">
                {value.title}
              </h3>
              <p className="font-sans text-xs text-[#242423]/60 leading-relaxed">
                {value.description}
              </p>
            </div>
          ))}
